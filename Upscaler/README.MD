...
-  **To install the Upscaler**, simply run the installer which u can [download here](https://github.com/obvCirmaci/Tievex-Tools/blob/main/Upscaler/UpscalerInstaller.CMD), which will install Scoop, Ffmpeg (Added to Path) and the upscaler itself.
