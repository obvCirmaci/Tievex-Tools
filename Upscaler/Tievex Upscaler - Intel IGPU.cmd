...
$Preferences = @{
    ...
    'Encoding Arguments' = 'H264 QuickSync'
...
<#
   The rest of this file is part of the script, don't mess with it unless you know what you're doing
        NVENC =       "h264_nvenc -preset p7 -rc vbr -b:v 250M -cq 15 -r 60"  
#>
...
$Presets = @{
    ...
    H264 = @{
        NVENC =       "h264_nvenc -r 60 -profile:v high -preset fast -rc constqp -qp 6"
        AMF =         "h264_amf -quality quality -qp_i 12 -qp_p 12 -qp_b 12"
        QuickSync =   "h264_qsv -preset veryslow -global_quality:v 6"
        CPU =         "libx264 -preset slower -x264-params aq-mode=3 -crf 5 -pix_fmt yuv420p10le"
    }
    H265 = @{
        NVENC =       "hevc_nvenc -preset p7 -rc vbr -b:v 250M -cq 6"   
        AMF =         "hevc_amf -quality quality -qp_i 16 -qp_p 6 -qp_b 20"
        QuickSync =   "hevc_qsv -preset veryslow -global_quality:v 6"
        CPU =         "libx265 -preset slow -x265-params aq-mode=3 -crf 5 -pix_fmt yuv420p10le"
    }
}
